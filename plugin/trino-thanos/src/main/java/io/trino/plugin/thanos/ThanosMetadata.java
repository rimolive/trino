        ...
        implements ConnectorMetadata
{
    ...
    public PrometheusTableHandle getTableHandle(ConnectorSession session, SchemaTableName tableName)
    {
        ...
        if (thanosClient.getTable(tableName.getSchemaName(), tableName.getTableName()) == null) {
            return null;
        }
    ...
    public Map<String, ColumnHandle> getColumnHandles(ConnectorSession session, ConnectorTableHandle tableHandle)
    {
        ...
        PrometheusTable table = thanosClient.getTable(prometheusTableHandle.getSchemaName(), prometheusTableHandle.getTableName());
        if (table == null) {
    ...
    private ConnectorTableMetadata getTableMetadata(SchemaTableName tableName)
    {
        ...
        PrometheusTable table = thanosClient.getTable(tableName.getSchemaName(), tableName.getTableName());
        if (table == null) {
            return null;
        }
